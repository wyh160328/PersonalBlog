			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">某高校社团联合会学生活动审批系统</a>
					</div>
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li>
								<a href="${pageContext.request.contextPath}/message/personMessageList.do">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						...
						<a href="${pageContext.request.contextPath}/procedure/searchList.do" class="list-group-item list-group-item-${ myPageNav=='5' ? 'success':'' } btn ">流程查找</a>
