				...
				<table class="table table-hover table-bordered">
					...
					<c:forEach var="myList" items="${procedureModelList }" varStatus="status" >
						<tr>
							...
							<td><a href="${pageContext.request.contextPath}/procedure/submitDetail.do?modelId=${myList.get('id') }" class="btn btn-info" type="button">选择</a>
								<a href="${pageContext.request.contextPath}/procedure/modelLook.do?modelId=${myList.get('id') }" class="btn btn-info">查看</a></td>
