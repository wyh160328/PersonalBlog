...
<html lang="en">
	...
	<head>
		...
		<script type="text/javascript">
			...
			+'                    </td>'
			+'                    <td>'
			+'                        <select id="pperson'+num+'" name="pperson'+num+'" style=\"width: 120px\">'
			+'                            <option value="0">——请选择——</option>'
			+'                        </select>'
			+'                    </td>'
			+'                    <td>'
									...
									<c:choose>
										<c:when test="${pmeIsNew }">
											<tr id="process1">
												...
												<td>
													<select id="pperson1" name="pperson1" style="width: 120px;">
														<option value="0">——请选择——</option>
													</select>
												</td>
												<td>
										...
										<c:otherwise>${pmeProcessMap.size() }
											<c:forEach var="mapIndex" begin="1" end="${pmeProcessMap.size() }">
												<tr id="process${mapIndex }">
													...
													<td>
														<select id="pperson${mapIndex }" name="pperson${mapIndex }" style="width: 120px">
															<option value="0">——请选择——</option>
