	...
	<head>
		...
		<script type="text/javascript">
			...
			window.addEventListener("load",function(){
				//表单提交验证
				var myFromMsg = document.getElementById("myFormSendMessage");
		...
		<div class="container-fluid">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<h3 align="center">发送消息</h3>
					<form action="${pageContext.request.contextPath}/message/sendMessageForm.do" method="post" id="myFormSendMessage" class="form-horizontal">
						<input type="hidden" id="mUserKind" value="${userKindNumber }" />
						<div class="form-group">
							<label for="mtitle" class="col-sm-2 control-label">标题</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="mtitle" name="mtitle" placeholder="填写消息的标题">
							</div>
						</div>
						<!--消息类型-->
						<div class="form-group">
							<label for="mkind" class="col-sm-2 control-label">消息类型</label>
							<div class="col-sm-10 ">
								<select id="mkind" name="mkind">
									<option value="0" selected="selected">——选择类型——</option>
									<option value="person">个人消息</option>
									<option value="group">小组消息</option>
									<option value="part">部门消息</option>
									<option value="company">学校消息</option>
								</select>
							</div>
						</div>
						<!--接受者 01-->
						<div id="kindAcceptg" class="form-group" hidden="true">
							...
							<div class="col-sm-10 ">
								...
								<select id="macceptg" name="macceptg">
									...
									<option value="0">小组1</option>
									<option value="1">小组2</option>
									<option value="2">小组3</option>
									<option value="3">小组4</option>
								</select>
							</div>
						</div>
						<!--接受者 02-->
						...
						<div class="form-group">
							<label for="mcontext" class="col-sm-2 control-label">消息内容</label>
							<div class="col-sm-10">
								<textarea class="form-control" id="mcontext" name="mcontext" placeholder="请填写消息内容。最多500个字符" rows="5" maxlength="500"></textarea>
							</div>
						</div>
