...
//		System.out.println(shens);
	...
	public int getSearchNumById(int id){
		return ppMapper.getSearchNumById(id);
	}
	public int getSearchNumByName(String name){
		return ppMapper.getSearchNumByName(name);
	}
	public int getSearchNumByProject(String projectName){
		return ppMapper.getSearchNumByProject(projectName);
	}

	public List<Map<String, Object>> getSearchListById(int id){
		return ppMapper.getSearchListById(id);
	}
	public List<Map<String, Object>> getSearchListByName(String name, int begin,  int end){
		return ppMapper.getSearchListByName(name,begin,end);
	}

	public List<Map<String, Object>> getSearchListByProject( String projectName,  int begin,  int end){
		return ppMapper.getSearchListByProject(projectName,begin,end);
	}
