...
//		}
		...
		if(info!=null){
			...
			session.setAttribute("post",info.getPost());
...
//			System.out.println("notice:"+notice);
	...
	public String refreshRemindNumber(HttpServletRequest req){
		...
		int notice = remindService.getRemindNoticeNumberById((String)session.getAttribute("userJobId"));
		String res = "msg:"+msg+",procedure:"+procedure+",all:"+(procedure+msg)+",notice:"+notice;
		return res;
	}
}
