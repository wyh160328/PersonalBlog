...
//		System.out.println(procedureDao);
	...
	public int getSearchNumById(int id){
		return procedureDao.getSearchNumById(id);
	}
	public int getSearchNumByName(String name){
		return procedureDao.getSearchNumByName(name);
	}
	public int getSearchNumByProject(String projectName){
		return procedureDao.getSearchNumByProject(projectName);
	}

	public List<Map<String, Object>> getSearchListById(int id){
		return procedureDao.getSearchListById(id);
	}
	public List<Map<String, Object>> getSearchListByNameOfPage(String name,int page){
		if(page<1){
			page = 1;
		}
		int begin = (page-1)*PAGE_MY;
		int end = PAGE_MY;
		return procedureDao.getSearchListByName(name,begin,end);
	}

	public List<Map<String, Object>> getSearchListByProjectOfPage( String projectName,int page){
		if(page<1){
			page = 1;
		}
		int begin = (page-1)*PAGE_MY;
		int end = PAGE_MY;
		return procedureDao.getSearchListByProject(projectName,begin,end);
